...
landmark.to_csv("20240927landmark_points.csv")
```
...
mdata.to_csv("20240927apple_metadata.csv", index = False)
```
...
apple_traits <- read.csv("20240927apple_metadata.csv")
...
write.csv(apple_traits, file = "20240927apple_metadata_avg.csv")
```
...
apple_traits <- read.csv("20240927apple_metadata_avg.csv") %>% 
  dplyr::select(2:16)
...
apple_data <- read.csv("20240927apple_metadata_avg.csv") %>% 
  dplyr::select(2:16)
...
write.csv(all_data, file = "20240927apple_metadata.csv")
```
...
new_mdata = pd.read_csv("20240927apple_metadata.csv")
...
new_mdata.to_csv("20240927apple_metadata.csv", index = False)
```
...
predicted <- read.delim("prediction_values.txt", sep = "")
apple_data <- read.csv("20240927apple_metadata.csv") %>% 
  dplyr::select(2:16, 22:28)
...
ggsave("0927_pairs_plot.png", plot = last_plot(), units = "in", width = 17, height = 15)
write.csv(all_data, file = "20240927apple_metadata.csv")
```
...
avgdata <- read.csv("20240927apple_metadata.csv")
...
write.csv(combined, file = "20240927apple_metadata.csv", row.names = FALSE)
```
...
averaged = pd.read_csv("20240927apple_metadata.csv")
...
cbar.set_label(hue)  # Label the color bar
...
averaged.to_csv("20240927apple_metadata.csv", index = False)
```
...
setwd("C:/Users/User/Desktop/COOP02/code/apple_shape")
data <- read.csv("20240927landmark_points.csv")
